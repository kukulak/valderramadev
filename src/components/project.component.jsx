...
function Project({item, notLive, hrefGit, hrefLive, urlImg, name, stack, textBtn, projectUrl, textInfo, mTop, text, video, caso}){
    ...
    return(
        ...
        <div className='projectContenedor' style={{ marginTop : mTop }}> 
            ...
            <ProjectImg urlImg={urlImg} name={name} textInfo={textInfo} notLive={notLive} hrefLive={hrefLive} hrefGit={hrefGit} text={text} caso={caso}/>
